...
export default function TestimonialDetailPage({
  ...
  const story = getTestimonial(id);
  // Unpublished reports and reports without consent are never served publicly.
  ...
  const related = school
    ? testimonialsForSchool(school.id).filter((s) => s.id !== story.id)
    : [];
