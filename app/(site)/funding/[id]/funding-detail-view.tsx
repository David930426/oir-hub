...
/** One funding call, with its program and form already resolved. */
export type SiteFundingDetail = {
  id: string;
  name: Localized;
...
export function FundingDetailView({
  ...
  funding: SiteFundingDetail;
  program: { slug: string; name: Localized } | null;
  form: MediaFile | null;
}) {
